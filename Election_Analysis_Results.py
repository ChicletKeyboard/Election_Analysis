...
# Initialize candidate options and candidate votes lists.
candidate_options = []
candidate_votes = {}
...
with open(load_file) as election_data:
    ...
    for row in reader:
        ...
        if candidate_name not in candidate_options:
            ...
            # Add the candidate name to the candidate list and begin tracking that candidate's voter count.
...
with open(file_to_save, "w") as txt_file:
    ...
    # 7: Print the county with the largest turnout to the terminal using f string.
